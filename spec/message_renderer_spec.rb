  ...
  describe MessageRenderer do
    ...
    context "small window" do
      ...
      it "should split the message to fit the window" do
        ...
        expect(renderer.render_lines(message)).to eq(["Eric: testing out MessageRende", "rer"])
      end
